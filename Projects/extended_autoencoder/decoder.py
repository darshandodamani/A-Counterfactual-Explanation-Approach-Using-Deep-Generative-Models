...
class Decoder(nn.Module):
    def __init__(self, latent_dims, num_epochs):
        ...
        # Note: If you changed the encoder to produce bigger flatten dims,
        #       keep these linear dimensions consistent.
        self.decoder_linear = nn.Sequential(
            nn.Linear(latent_dims, 1024),
            nn.LeakyReLU(),
            # We expect the final shape to match 512 x 4 x 9, for instance,
            # if your image is 80 x 160. Adjust if needed.
