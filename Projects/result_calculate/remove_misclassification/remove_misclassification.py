...
# Run for 4-class
misclassified_4c = find_misclassified_images(methods_results_4_class, "results/misclassified_images_4_classes.csv")

# Run for 2-class
misclassified_2c = find_misclassified_images(methods_results_2_class, "results/misclassified_images_2_classes.csv")
