#location: Projects/masking/initialize_masking_pipeline_4_classes.py
"""
...
INITIAL_PREDICTIONS_CSV = "results/masking/common_initial_predictions_4_classes.csv"

# Dictionary mapping method names to their results CSV file paths.
METHODS_RESULTS: Dict[str, str] = {
    "grid_based": "results/masking/grid_based_masking_4_classes_results.csv",
    "lime_on_image": "results/masking/lime_on_image_masking_4_classes_results.csv",
    "object_detection": "results/masking/object_detection_masking_4_classes_results.csv",
    "lime_on_latent": "results/masking/lime_on_latent_masking_4_classes_results.csv",
}
