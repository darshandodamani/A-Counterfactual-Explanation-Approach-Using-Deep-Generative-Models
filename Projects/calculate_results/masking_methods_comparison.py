...
def main() -> None:
    ...
    for class_type in class_types:
        ...
        object_detection_csv = current_files["object_detection"]
        ...
        comparison_table = generate_comparison_table(all_images, grid_ce, lime_latent_ce, lime_image_ce, object_detection_ce)
        ...
        # Generate and save the Venn diagram and bar chart
        venn_sets = {
