...
# Path where the trained Logistic Regression classifier will be saved (as a .pth file)
classifier_save_path = os.path.join(MODEL_DIR, "logistic_regression_classifier_4_classes.pth")
...
# ------------------------------------------------------------------------------
logistic_classifier = LogisticRegression(multi_class='ovr', max_iter=1000, random_state=42)
...
plt.ylabel("True")
plt.title("Confusion Matrix for Logistic Regression Classifier (4 Classes)")
cm_path = os.path.join(PLOTS_DIR, "logistic_regression_confusion_matrix.png")
plt.savefig(cm_path)
...
plt.title("ROC Curves for Logistic Regression Classifier (4 Classes)")
plt.legend(loc="lower right")
roc_path = os.path.join(PLOTS_DIR, "logistic_regression_roc_curve.png")
plt.savefig(roc_path)

# ------------------------------------------------------------------------------
# Save the Trained Logistic Regression Classifier as a .pth File
# ------------------------------------------------------------------------------
# Note: Although Logistic Regression is not a PyTorch module, torch.save() uses pickle under the hood.
torch.save(logistic_classifier, classifier_save_path)
print(f"Logistic Regression classifier saved at: {classifier_save_path}")