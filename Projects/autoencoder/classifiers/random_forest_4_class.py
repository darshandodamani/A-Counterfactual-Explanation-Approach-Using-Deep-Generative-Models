...
# Path where the trained Random Forest classifier will be saved (as a .pth file)
classifier_save_path = os.path.join(MODEL_DIR, "rf_classifier_4_classes.pth")
...
plt.ylabel("True")
plt.title("Confusion Matrix for Random Forest Classifier (4 Classes)")
cm_path = os.path.join(PLOTS_DIR, "rf_confusion_matrix.png")
plt.savefig(cm_path)
...
plt.title("ROC Curves for Random Forest Classifier (4 Classes)")
plt.legend(loc="lower right")
roc_path = os.path.join(PLOTS_DIR, "rf_roc_curve.png")
plt.savefig(roc_path)

# ------------------------------------------------------------------------------
# Save the Trained Random Forest Classifier as a .pth File
# ------------------------------------------------------------------------------
# Note: Although Random Forest is not a PyTorch module, torch.save() uses pickle under the hood.
torch.save(rf_classifier, classifier_save_path)
print(f"Random Forest classifier saved at: {classifier_save_path}")